...
void Stats::draw() {
    ...
    glPushMatrix();  
        ...
        glPushMatrix(); 
            ...
            glRasterPos2i(current_width - current_width *0.5, current_height - current_height*0.9); 
            
            glColor3f(0.2,1,0.2);
            for (auto c : m_portal_hp_string)
                glutBitmapCharacter(GLUT_BITMAP_HELVETICA_18, c);

            glRasterPos2i(current_width - current_width *0.7, current_height - current_height*0.9);
            for (auto c : m_mana_string)
                glutBitmapCharacter(GLUT_BITMAP_HELVETICA_18, c);


            glRasterPos2i(current_width - current_width *0.3, current_height - current_height*0.9);
